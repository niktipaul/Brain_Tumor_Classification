...
print('\n\n\n\n\n======== Testing CNN Starts Here ========\n')

# Importing our CNN Model
fh_cnn = open('5_models\\cnn.json','r+')
cnn_json = fh_cnn.read()
fh_cnn.close()
cnn = model_from_json(cnn_json)
cnn.load_weights("5_models\\cnn.h5")
...
print("\n[+]Beginning Prediction For cnn...")

predicted = cnn.predict(image_set)
predicted_set = []
for arr in predicted:
  predicted_set.append(np.argmax(arr))

print("[+]Prediction Finished!!!\n")
print("\n===== OVERALL EVALUATION DETAILS FOR CNN MODEL =====\n")
...
print("\nAccuracy of CNN Model =",accuracy_var)
...
plt.savefig("6_confusion_matrix\\cnn_confMat.jpg")

# Updating STATS

csv_path = "8_statistics\\stats.csv"
my_funcs.write_as_stats_u('CNN',csv_path,accuracy_var,precision,recall,f1,total_images)
