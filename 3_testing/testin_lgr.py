...
print('\n\n\n\n\n======== Testing LGR Starts Here ========\n')

# Importing our LGR Model

fh_logr = open('5_models\\logr.sav','rb+')
lgr = pickle.load(fh_logr)
...
print("\n[+]Beginning Prediction For Logistic Regression...")

image_set = image_set.reshape(len(image_set),-1)
predicted_set = lgr.predict(image_set)

print("[+]Prediction Finished!!!\n")
print("\n===== OVERALL EVALUATION DETAILS FOR LGR MODEL =====\n")
...
plt.savefig("6_confusion_matrix\\lgr_confMat.jpg")

# Updating STATS

csv_path = "8_statistics\\stats.csv"
my_funcs.write_as_stats_u("Logistic Regression",csv_path,accuracy_var,precision,recall,f1,total_images)
