...
print('\n\n\n\n\n======== Testing leNet Starts Here ========\n')

# Importing our leNet Model
fh_leNet = open('5_models\\leNet.json','r+')
leNet_json = fh_leNet.read()
fh_leNet.close()
leNet = model_from_json(leNet_json)
leNet.load_weights("5_models\\leNet.h5")
...
print("\n[+]Beginning Prediction For leNet...")

predicted = leNet.predict(image_set)
predicted_set = []
for arr in predicted:
  predicted_set.append(np.argmax(arr))

print("[+]Prediction Finished!!!\n")
print("\n===== OVERALL EVALUATION DETAILS FOR leNet MODEL =====\n")
...
plt.savefig("6_confusion_matrix\\leNet_confMat.jpg")

# Updating STATS

csv_path = "8_statistics\\stats.csv"
my_funcs.write_as_stats_u('leNet',csv_path,accuracy_var,precision,recall,f1,total_images)
